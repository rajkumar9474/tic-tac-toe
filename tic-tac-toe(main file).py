def win_check(gm_mt):
    ...
    Args:
        gm_mt (list): The tic-tac-toe game board.

    Returns:
        tuple: A tuple containing:
            - 1 if a player has won, 0 if no winner yet.
            - 0 if it's a tie, 1 if Player 1 ('o') wins, or 2 if Player 2 ('x') wins.
    """
    if (gm_mt[0] == gm_mt[1] and gm_mt[1] == gm_mt[2]):
        if (gm_mt[0] == "o"):
            return 1, 1  # Player 1 (o) won
        else:
            return 1, 2  # Player 2 (x) won
